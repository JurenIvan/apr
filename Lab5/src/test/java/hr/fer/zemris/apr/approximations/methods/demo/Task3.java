...
public class Task3 {
    ...
    private static final int x0_2 = 3;
    private static final double INTEGRATION_PERIOD = 0.01;
    //    private static final double INTEGRATION_PERIOD = 0.036;
    ...
    public static void main(String[] args) {
        ...
        XYChart chart3 = new XYChartBuilder().width(1920).height(1080).title("Shift error").xAxisTitle("t*0.01").yAxisTitle("Cumulative error").build();
        ...
        XYChart chart4 = new XYChartBuilder().width(1920).height(1080).title("Speed Error").xAxisTitle("t*0.01").yAxisTitle("Cumulative error").build();
    ...
    private static List<ApproxHistoryRecord> aprox(Approximation method) {
        var a = Matrix.parseString("0 -2 | 1 -3");
        var x = Matrix.parseString(x0_1 + " | " + x0_2);

        var b = Matrix.parseString("2 0 | 0 3");
        var r = Matrix.parseString("1 | 1");

        method.approximate(x, a, b, r, 10, INTEGRATION_PERIOD, false);
